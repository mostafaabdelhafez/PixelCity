...
func FlickrUrl(ForKey ApiKey:String,WithAnnotation Annotation:DropAnnotation)->String{
    ...
    let FinalUrl = "https://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=\(UrlKey)&lat=\(Annotation.coordinate.latitude)&lon=\(Annotation.coordinate.longitude)&radius=1&radius_units=mi&per_page=4&format=json&nojsoncallback=1"
    return FinalUrl
}
